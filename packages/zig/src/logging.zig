...
pub const LogConfig = struct {
    level: LogLevel = if (std.ascii.eqlIgnoreCase(@tagName(builtin.mode), "debug")) .debug else .info,
    target: LogTarget = .stderr,
    colored: bool = true,
    show_timestamp: bool = true,
    show_module: bool = true,
    show_source: bool = std.ascii.eqlIgnoreCase(@tagName(builtin.mode), "debug"),
