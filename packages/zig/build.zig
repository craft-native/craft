...
pub fn build(b: *std.Build) void {
    ...
    android_conformance_tests.root_module.addAnonymousImport("src/bridge_android_clipboard.zig", .{
        .root_source_file = b.path("src/bridge_android_clipboard.zig"),
    });
    ...
    android_conformance_tests.root_module.addAnonymousImport("src/bridge_android_imagepicker.zig", .{
        .root_source_file = b.path("src/bridge_android_imagepicker.zig"),
    });
    ...
    android_conformance_tests.root_module.addAnonymousImport("src/bridge_android_audio.zig", .{
        .root_source_file = b.path("src/bridge_android_audio.zig"),
    });
    ...
    android_conformance_tests.root_module.addAnonymousImport("src/bridge_android_billing.zig", .{
        .root_source_file = b.path("src/bridge_android_billing.zig"),
    });
    android_conformance_tests.root_module.addAnonymousImport("src/bridge_android_ml.zig", .{
        .root_source_file = b.path("src/bridge_android_ml.zig"),
    });
    android_conformance_tests.root_module.addAnonymousImport("src/bridge_android_pdf.zig", .{
        .root_source_file = b.path("src/bridge_android_pdf.zig"),
    });
    ...
    ios_conformance_tests.root_module.addAnonymousImport("src/bridge_mobile_bluetooth.zig", .{
        .root_source_file = b.path("src/bridge_mobile_bluetooth.zig"),
    });
    ios_conformance_tests.root_module.addAnonymousImport("src/bridge_mobile_audiorec.zig", .{
        .root_source_file = b.path("src/bridge_mobile_audiorec.zig"),
    });
    ios_conformance_tests.root_module.addAnonymousImport("src/bridge_mobile_health.zig", .{
        .root_source_file = b.path("src/bridge_mobile_health.zig"),
    });
    ...
    ios_conformance_tests.root_module.addAnonymousImport("src/bridge_mobile_imagepicker.zig", .{
        .root_source_file = b.path("src/bridge_mobile_imagepicker.zig"),
    });
    ios_conformance_tests.root_module.addAnonymousImport("src/bridge_mobile_filepicker.zig", .{
        .root_source_file = b.path("src/bridge_mobile_filepicker.zig"),
    });
